...
var activity = prompt("We are getting closer to the story, which is an activity. Our characters need an activity too!");
...
var story = function storyTime(character, trait, year, house, friend, activity, end){
	alert("Once upon a time there was a " + trait + " adventurer, whos name was " + character + " 