	...
	if(inputWebsite === "Y" && inputHosting === "Y"){
		...
		var priceUpHost = 40
			...
			if(inputWebsite === "Y" && inputHosting === "Y" && inputUpgradeBoth === "Y"){
				...
				console.log("You did not the proper inputs somewhere! For all answers input Y or N"); //this is still popping up! Why?!
			}
		}else{
			alert("Use still has not refreshed after using incorrect inputs!");
