	...
	if(inputWebsite === "Y" && inputHosting === "Y"){
		...
		if(inputWebsite === "Y" && inputHosting === "Y"){
			...
			if(inputWebsite === "Y" && inputHosting === "Y" && inputUpgradeBoth === "Y"){
				...
				console.log("You did not the proper inputs somewhere! For all answers input Y or N");
			}
		}else{
			alert("User still has not refreshed after using incorrect inputs!");
			console.log("User still has not refreshed after using incorrect inputs!");
		}
	}else{
